				...
				<div className="profile-wrapper">
					<div className="profile">
						<p>
							...
							foundations of programming and all the concepts needed to work as
							a full-stack web developer. I further enhanced my coding
							experience with Udacity full-stack web development Nanodegree
							program and got certified as a full-stack web developer. Over the
							years, I have developed and accomplished different projects
							involving user interface and experience, identity access
							management, data storage and modeling, API development and
							documentation, server deployment and containerization. My goal has
							always been not to build just a website but to help you develop
